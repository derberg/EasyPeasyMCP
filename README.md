...
```bash
# Use absolute path
claude mcp add my-project npx easy-peasy-mcp@0.0.6 \
...
```bash
claude mcp add asyncapi npx easy-peasy-mcp@0.0.6 -- \
  --name "asyncapi" \
...
```bash
npx --package=easy-peasy-mcp@0.0.6 easy-peasy-build \
  --docs ./guides \
  --docs ./api-reference \
  --openapi ./openapi \
  --asyncapi ./asyncapi \
