...
```bash
claude mcp add my-project npx easy-peasy-mcp@0.0.4 \
...
```bash
claude mcp add asyncapi npx easy-peasy-mcp@0.0.4 -- \
  --name "asyncapi" \
...
```bash
npx --package=easy-peasy-mcp@0.0.4 easy-peasy-build \
  --docs ./guides \
  --docs ./api-reference \
  --openapi ./openapi \
  --asyncapi ./asyncapi \
